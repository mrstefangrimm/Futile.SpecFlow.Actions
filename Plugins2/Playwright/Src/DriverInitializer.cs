...
{
    Task<IBrowser> GetChromeDriverAsync(string[]? args = null, float? timeout = DriverInitializer.DEFAULT_TIMEOUT, bool? headless = true, float? slowmo = null, string? traceDir = null);
    Task<IBrowser> GetEdgeDriverAsync(string[]? args = null, float? timeout = DriverInitializer.DEFAULT_TIMEOUT, bool? headless = true, float? slowmo = null, string? traceDir = null);
    Task<IBrowser> GetFirefoxDriverAsync(string[]? args = null, float? timeout = DriverInitializer.DEFAULT_TIMEOUT, bool? headless = true, float? slowmo = null, string? traceDir = null);
    Task<IBrowser> GetChromiumDriverAsync(string[]? args = null, float? timeout = DriverInitializer.DEFAULT_TIMEOUT, bool? headless = true, float? slowmo = null, string? traceDir = null);
    Task<IBrowser> GetWebKitDriverAsync(string[]? args = null, float? timeout = DriverInitializer.DEFAULT_TIMEOUT, bool? headless = true, float? slowmo = null, string? traceDir = null);
}
