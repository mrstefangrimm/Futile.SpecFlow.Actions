...
public class SafariDriverInitializer : DriverInitializer<SafariOptions>
{
    ...
    public SafariDriverInitializer(ISeleniumConfiguration seleniumConfiguration, ICredentialProvider credentialProvider)
